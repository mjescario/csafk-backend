...
\f0\fs24 \cf0 Graph Implementation Documentation\
\
**SETUP**\
\
...
\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
\cf0 'GET /api/projects/\{project_id\}/stats'\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
\cf0 \
This will require credentials: \'93include\'94 to run. A successful sample response will look like this:\
\
```\
\{\
  "success": true,\
  "data": \{\
    "project_id": 272,\
    "project_title": "Bird Watch \'97 Spring 2024",\
...
```\
\
* field_type: checkbox into PieChartCard. Need to rename keys and convert \'93true\'94 or \'93false\'94 strings to \'93Yes\'94 or \'93No\'94 to render properly:\
\
```\
...
* Rechart Component: \'93NumericCard\'94\
* Stats Shape:\
\
'\{ count, min, max, mean \}'\
\
...
* Rechart Component: \'93PieChartCard\'94 or \'93BarChartCard\'94\
* Stats Shape:\
\
...
* Field Type: checkbox\
* Chart Type: pie\
* Rechart Component: \'93PieChartCard\'94\
* Stats Shape:\
\
...
* Field Type: date\
* Chart Type: line\
* Rechart Component: \'93LineChartCard\'94\
* Stats Shape:\
\
'\{ timeline: [\{date, count\}] \}'\
\
...
* Chart Type: none\
* Rechart Component: \'93TextCard\'94\
* Stats Shape:\
\
'\{ count \}'}